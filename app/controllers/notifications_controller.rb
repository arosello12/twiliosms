class NotificationsController < ApplicationController
  ...
  def incoming
    ...
    begin
      ...
      puts "APP: Something went wrong. Try again"  
    ...
    def process_message(message, subscriber)
      if message == 'subscribe' || message == 'unsubscribe'
        ...
        if !subscriber.subscribed
          output = "You have unsubscribed from notifications. Text 'subscribe' to start receieving updates again"
        end
      else
